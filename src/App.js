...
const App = () => {
  ...
  const [squareDropped, setSquareDropped] = useState(null)
  ...
  const dragEnd = (e) => {
    ...
    const squareBeingDraggedId = 
      parseInt(squareBeingDragged.getAttribute('data-id'))
    const squareBeingReplacedId = 
